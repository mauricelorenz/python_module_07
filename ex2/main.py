...
def main() -> None:
    ...
    print(f"- Card: {[method for method in Card.__dict__.keys()
                      if not method.startswith("_")]}")
    print(f"- Combatable: {[method for method in Combatable.__dict__.keys()
                            if not method.startswith("_")]}")
    print(f"- Magical: {[method for method in Magical.__dict__.keys()
                         if not method.startswith("_")]}")
